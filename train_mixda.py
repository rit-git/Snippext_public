...
if __name__=="__main__":
    ...
    parser.add_argument("--logdir", type=str, default="checkpoints_mixda/")
    parser.add_argument("--bert_path", type=str, default=None)
    parser.add_argument("--alpha_aug", type=float, default=0.8)
    parser.add_argument("--augment_index", type=str, default="augment_index.json")
    parser.add_argument("--augment_op", type=str, default='token_ins')
